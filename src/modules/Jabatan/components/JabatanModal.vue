<template>
  <Teleport to="body">
    <div class="modal fade" :id="id" tabindex="-1" aria-labelledby="jabatanModalLabel" aria-hidden="true"
            ...
            <div class="content">
              <div class="modal-header border-0 custom-modal-header">
                <div class="page-title">
                  <h4>{{ isEditMode ? 'EDIT JABATAN' : 'TAMBAH JABATAN' }}</h4>
                </div>
              ...
              <div class="modal-body custom-modal-body">
                <form @submit.prevent="submitForm">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="namaJabatan" v-model="localForm.jabatan"
                      :class="{ 'is-invalid': initialErrors.jabatan }">
                    <div class="invalid-feedback" v-if="initialErrors.jabatan">
